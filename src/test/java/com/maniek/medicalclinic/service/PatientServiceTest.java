...
public class PatientServiceTest {
    ...
    void setUp() {
        ...
        this.patientService = new PatientService(patientRepository, patientMapper, passwordEncoder);
    }
    ...
    void showPatient_PatientsExist_PatientsReturned() {
        ...
        Patient patient = new Patient(1L,"dsadsa", "sdsa", Role.PATIENT, "dasds", "Masds", "dsadsad", "987465376", LocalDate.of(1995, 12, 05), new HashSet<>());
        Patient patient1 = new Patient( 1L,"fdsfsd", "dsad",Role.PATIENT, " fhhgf", "fghfg", "fghfgh", "986345213", LocalDate.of(1995, 04, 12), new HashSet<>());
    ...
    void addPatient_CorrectData_PatientAdded() {
        Patient patient2 = new Patient(1L,"ouyut", "43543",Role.PATIENT, "67756", "kjhk", "qewqe", "67567", LocalDate.of(1997, 06, 10), new HashSet<>());
    ...
    void addPatient_PatientValidateInfo_ExceptionThrown() {
        Patient patient2 = new Patient(1L,"ouyut", null,Role.PATIENT, "67756", "kjhk", "qewqe", "67567", LocalDate.of(1997, 06, 10), new HashSet<>());
        when(patientRepository.findByEmail(eq("ouyut"))).thenReturn(Optional.empty());
    ...
    void editPatient_PatientExists_PatientEdited() {
        Patient patient = new Patient(1L,"dsadsa", "sdsa",Role.PATIENT, "dasds", "Masds", "dsadsad", "987465376", LocalDate.of(1995, 12, 05), new HashSet<>());
        Patient editInfo = new Patient(2L,"htyht", "htyht",Role.PATIENT, "dasds", "gdfgdf", "hgfhgfh", "567456354", LocalDate.of(1987, 05, 12), new HashSet<>());
    ...
    void editPatient_PatientExistsWithEmail_PatientEdited() {
        Patient patient = new Patient(1L,"dsadsa", "sdsa",Role.PATIENT, "dasds", "Masds", "dsadsad", "987465376", LocalDate.of(1995, 12, 05), new HashSet<>());
        Patient editInfo = new Patient(1L,"dsadsa", "htyht",Role.PATIENT, "dasds", "gdfgdf", "hgfhgfh", "567456354", LocalDate.of(1987, 05, 12), new HashSet<>());
        when(patientRepository.findByEmail(eq(patient.getEmail()))).thenReturn(Optional.of(patient));
//        when(patientRepository.editPatient(eq(patient.getEmail()), eq(editInfo))).thenReturn(Optional.of(editInfo));
    ...
    void editPatient_PatientNotFound_ExceptionThrown() {
        Patient editInfo = new Patient(1L,"htyht", "htyht",Role.PATIENT, "rewrew", "gdfgdf", "hgfhgfh", "567456354", LocalDate.of(1987, 05, 12), new HashSet<>());
        when(patientRepository.findByEmail(eq("dsadsa"))).thenReturn(Optional.empty());
    ...
    void editPatient_IncorrectIdCardNo_ExceptionThrown() {
        Patient patient = new Patient(1L,"dsadsa", "sdsa",Role.PATIENT, "dasds", "Masds", "dsadsad", "987465376", LocalDate.of(1995, 12, 05), new HashSet<>());
        Patient editInfo = new Patient(2L,"dsadsa", "htyht",Role.PATIENT, "gfdgd", "gdfgdf", "hgfhgfh", "567456354", LocalDate.of(1987, 05, 12), new HashSet<>());
        when(patientRepository.findByEmail(eq("dsadsa"))).thenReturn(Optional.of(patient));
    ...
    void editPatient_PatientEmailIsExists_ExceptionThrown() {
        Patient patient = new Patient(1L,"dsadsa", "sdsa",Role.PATIENT, "dasds", "Masds", "dsadsad", "987465376", LocalDate.of(1995, 12, 05), new HashSet<>());
        Patient editInfo = new Patient(1L,"dfgfd", "htyht",Role.PATIENT, "dasds", "gdfgdf", "hgfhgfh", "567456354", LocalDate.of(1987, 05, 12), new HashSet<>());
    ...
    void editPatient_PatientValidateInfo_ExceptionThrown() {
        Patient patient = new Patient(1L,"dsadsa", "sdsa",Role.PATIENT, "dasds", "fsdfds", "dsadsad", "987465376", LocalDate.of(1995, 12, 05),new HashSet<>());
        Patient editInfo = new Patient(1L,"dfgfd", "htyht",Role.PATIENT, "gfdgd", null, "hgfhgfh", "567456354", LocalDate.of(1987, 05, 12), new HashSet<>());
    ...
    void editPassword_PatientNotFound_ExceptionThrown() {
        String password = "dsads";
        String email = "jghjgh";
        when(patientRepository.findByEmail("dsadsa")).thenReturn(Optional.empty());
